...
import fr.colline.monatis.controller.dto.BeneficiaireRequestDto;
import fr.colline.monatis.controller.dto.BeneficiaireResponseDto;
import fr.colline.monatis.controller.dto.mapper.BeneficiaireDtoMapper;
...
public class BeneficiaireController {
	...
	@GetMapping("/all")
	public List<BeneficiaireResponseDto> getAllBeneficiaire() 
			throws ControllerException {

		try {
			List<BeneficiaireResponseDto> resultat = new ArrayList<>();
			Sort tri = Sort.by("nom");
			List<Beneficiaire> liste = beneficiaireService.rechercherTous(tri);
			for ( Beneficiaire beneficiaire : liste ) {
				resultat.add(BeneficiaireDtoMapper.detailedModelToResponseDto(beneficiaire));
			}
			return resultat;
		} 
	...
	@GetMapping("/get/{nom}")
	public BeneficiaireResponseDto getBeneficiaireParNom(@PathVariable String nom) 
			throws ControllerException {
		...
		try {
			...
			return BeneficiaireDtoMapper.detailedModelToResponseDto(beneficiaire);
		} 
		catch (ServiceTechniqueException e) {
			throw new ControllerException(
					e,
	...
	@PostMapping("/new")
	public BeneficiaireResponseDto creerBeneficiaire(@RequestBody BeneficiaireRequestDto dto) 
			throws ControllerException {
	...
	@PutMapping("/mod/{nom}")
	public BeneficiaireResponseDto modifierBeneficiaire(

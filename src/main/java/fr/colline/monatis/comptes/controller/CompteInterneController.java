...
import fr.colline.monatis.comptes.controller.dto.internes.CompteInterneRequestDto;
...
public class CompteInterneController {
	...
	@GetMapping("/all")
	public List<CompteInterneDetailedResponseDto> getAllComptesInternes() 
			throws ControllerException {

		try {
			List<CompteInterneDetailedResponseDto> resultat = new ArrayList<>();
			...
			for ( CompteInterne compteInterne : liste ) {
				resultat.add(CompteInterneDtoMapper.modelToDetailedResponseDto(compteInterne));
			}
			return resultat;
		} 
	...
	public CompteInterneDetailedResponseDto getCompteInterneParIdentifiant(@PathVariable(name = "identifiant") String identifiant) 
			throws ControllerException {
	...
	@PostMapping("/new")
	public CompteInterneDetailedResponseDto creerCompteInterne(@RequestBody CompteInterneRequestDto dto) 
			throws ControllerException {

...
import fr.colline.monatis.comptes.controller.dto.tiers.CompteTiersRequestDto;
...
public class CompteTiersController {
	...
	@GetMapping("/all")
	public List<CompteTiersDetailedResponseDto> getAllComptesTiers() 
			throws ControllerException {

		try {
			List<CompteTiersDetailedResponseDto> resultat = new ArrayList<>();
			...
			for ( CompteTiers compteTiers : liste ) {
				resultat.add(CompteTiersDtoMapper.modelToDetailedResponseDto(compteTiers));
			}
			return resultat;
		} 

...
public class SousCategorieController {
	...
	@GetMapping("/all")
	public List<SousCategorieDetailedResponseDto> getAllSousCategorie() 
			throws ControllerException {

		try {
			List<SousCategorieDetailedResponseDto> resultat = new ArrayList<>();
			...
			for ( SousCategorie sousCategorie : liste ) {
				resultat.add(SousCategorieDtoMapper.modelToDetailedResponseDto(sousCategorie));
			}
			return resultat;
		} 
	...
	@GetMapping("/get/{nom}")
	public SousCategorieDetailedResponseDto getSousCategorieParNom(@PathVariable(name = "nom") String nom) 
			throws ControllerException {
	...
	@PostMapping("/new")
	public SousCategorieDetailedResponseDto creerSousCategorie(@RequestBody SousCategorieRequestDto dto) 
			throws ControllerException {
